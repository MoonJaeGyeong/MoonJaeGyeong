...
<!-- github-profile-trophy 서비스가 현재 중단 상태(HTTP 402)라 임시 비활성화. 복구되면 아래 주석을 해제하세요. (2026-09-18 재확인: 여전히 402)
...
<!-- github-readme-activity-graph 서비스가 현재 중단 상태(HTTP 402)라 임시 비활성화. 복구되면 아래 주석을 해제하세요. (2026-09-18 재확인: 여전히 402)
